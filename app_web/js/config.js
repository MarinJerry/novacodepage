...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $urlRouterProvider.otherwise("/dashboards_top/dashboard_4");
 ...
 */
        ...
        .state('security.control', {
            ...
            data: { pageTitle: 'Control de Accesos' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('articles.control', {
            url: "/control/",
            templateUrl: "views/c_articles.html",
            data: { pageTitle: 'Control de Articulos' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
